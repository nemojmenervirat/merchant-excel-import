 ...
 */
@PWA(name = "Merchant Excel Import", shortName = "Merchant Excel Import", enableInstallPrompt = false)
@Theme(themeFolder = "merchantexcelimport")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Merchant Excel Import logo"));
        logoLayout.add(new H1("Merchant Excel Import"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Import", "la la-file-import", ImportView.class), //
